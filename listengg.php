			...
			<div class="container">
				...
				<nav id="navigation">
					<ul>
						...
						<li class="active"><a href="listengg.php">Engineers</a></li>
					...
					<section class="post">
						<?php 
                                                 if(isset ($_GET['msg'])){
                                                    ...
                                                    echo "<font color='maroon'>Employee record edited successfully</font>";
                                                    }else if($_GET['msg']==23){
                                                    echo "<font color='maroon'>Cannot edit the record, please try later</font>";
                                                    }else if($_GET['msg']==24){
                                                    echo "<font color='maroon'>Employee record deleted successfully</font>";
                                                    }else if($_GET['msg']==25){
                                            ...
                                            <table border="2px;" width="100%">
                                              ...
                                              while($row=  mysql_fetch_assoc($result)){
                                                  echo "<tr>
                                                          ...
                                                          <td>{$row['email']}</td>
                                                          <td>{$row['mobile']}</td>
                                                          <td align='center'><a href='listengg.php?id={$row['eid']}'><img src='images/edit.png'/></a></td>
                                                          <td align='center'><a href='deleteemp.php?id={$row['eid']}'><img src='images/delete.png'/></a></td></tr>";
                                              }
                                              ?> 
                                             </table>
                                            ...
                                            if(isset($_GET['id'])){
                                              echo "<form name='f' action='editemp.php' method='post' onsubmit='javascript:return validate();'>
                                                    <center><br/><table>";
                                              $query="SELECT * FROM tblemployee where eid='{$_GET['id']}'";
                                              $result=mysql_query($query);
                                              $row= mysql_fetch_assoc($result);
                                                  echo "<tr><td>Name:</td><td><input type='text' name='name' value='{$row['name']}' size='40'/></td></tr>
                                                          ...
                                                          <tr><td>Mobile:</td><td><input type='text'name='mob' value='{$row['mobile']}' maxlength='10' size='40' onkeypress='return isNumberKey(event)'/></td></tr>
                                                          <tr><td></td><td><input type='submit' value='Edit Details'/></td></tr>
                                                          <input type='hidden' name='empid' value='{$_GET['id']}'/></table>";
                                              }
                                              ?> 
                                                    <div class="cl">&nbsp;</div>
					</section>
