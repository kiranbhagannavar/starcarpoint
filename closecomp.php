					...
					<section class="post">
                                              ...
                                              if(mysql_num_rows($result)>0){
                                                  ...
                                                  echo "<tr><input type='hidden' name='pid' value='{$_GET['id']}'/>
                                                          ...
                                                          <tr><td></td><td><input type='submit' value='Close Complaint'/></td></tr>";
                                            ...
                                            <?php 
                                                if(isset($_POST['desc'])){
                                                    $query="update tblcomplaints set status='Closed', comment='{$_POST['desc']}', close_date=NOW() where cid={$_POST['pid']}";
                                                    $result=mysql_query($query);
                                                    if($result){
